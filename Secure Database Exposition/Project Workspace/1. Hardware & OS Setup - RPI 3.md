...
- [How to install Ubuntu Server on your Raspberry Pi | Ubuntu](https://ubuntu.com/tutorials/how-to-install-ubuntu-on-your-raspberry-pi#5-install-a-desktop)
...
- Raspberry Pi & Operating Systems
	- [Upgrade Raspberry Pi OS Lite to Desktop (PIXEL, KDE, …) – RaspberryTips](https://raspberrytips.com/upgrade-raspbian-lite-to-desktop/)
...
- Other Desktops for RPi Home Server
	...
	- [(1) Is This the ULTIMATE Home Cloud Solution? OMV + CasaOS - YouTube](https://www.youtube.com/watch?v=UWlrodHF1EE) 
	- [(1) Revisiting CasaOS After A Few Months - YouTube](https://www.youtube.com/watch?v=FwJByjTdKks) 
